#include "hreadelf.h"
/**
 * printinstruction_32 - print struct with info string
...
/**
 *printmachine_32 - prints arquitecture
...
void printmachine_32(Elf32_Half machine)
{
	...
	printinstruction_32(machines, 18, machine);
}

/**
 * printtype_32 - prints the object file type
 * @type: type bytes
 */
void printtype_32(Elf32_Half type)
{
	...
	printf("%6s%-31c", "Type", ':');
	printinstruction_32(types, 5, type);
}

/**
 * printosabi_32 - prints OS, ABI to which the object is
 * targeted, and ABI version
 * @ident: elf osabi
 */
void printosabi_32(unsigned char *ident)
{
	...
	printinstruction_32(osabi, 8, ident[EI_OSABI]);
